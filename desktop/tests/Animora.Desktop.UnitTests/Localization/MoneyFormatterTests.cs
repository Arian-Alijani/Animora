...
public class MoneyFormatterTests
{
    ...
    {
        MoneyFormatter.FormatRials(864_500_000m).Should().Be("۸۶۴,۵۰۰,۰۰۰ ریال");
    }
    ...
    public void FormatTomans_divides_by_ten_and_appends_the_toman_suffix()
    {
        ...
        MoneyFormatter.FormatTomans(864_500_000m).Should().Be("۸۶,۴۵۰,۰۰۰ تومان");
    }
    ...
    {
        MoneyFormatter.FormatRials(amount).Should().Be(expected);
    }
    ...
    public void FormatTomans_rounds_a_fractional_toman_remainder_to_the_nearest_whole_toman()
    {
        ...
        MoneyFormatter.FormatTomans(12_345m).Should().Be("۱,۲۳۴ تومان");
    }
    ...
    public void FormatRials_ignores_the_decimal_places_ledger_amounts_are_persisted_with()
    {
        ...
        MoneyFormatter.FormatRials(1500.00m).Should().Be("۱,۵۰۰ ریال");
    }
}
