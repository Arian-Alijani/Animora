...
- [ ] 32. Call `AddIdentityModule()` from `Animora.Desktop.App/Composition/ServiceCollectionExtensions` as the module's only appearance in the composition root (DESK-ARCH-05, DT-09)
