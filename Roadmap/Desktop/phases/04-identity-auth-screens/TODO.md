...
- [ ] 11. Add `Modules.Identity/Data/IStaffReadStore` + `IStaffWriteStore`: the module-owned staff seams, split read/write (DIR-03, DT-02, DT-05)
- [ ] 12. Add `Modules.Identity/Data/IRoleReadStore` + `IRoleWriteStore` (DIR-03, DT-05)
