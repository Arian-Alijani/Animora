...
- [ ] 7. Add `Modules.Identity/Models/StaffMember`: the list-row and form read model, storage units and UTC instants only (INV-13, DESK-ARCH-14)
- [ ] 8. Add `Modules.Identity/Models/Role`: display name, assigned claim keys, member count and the system-role flag SEC-11 needs (SEC-09, SEC-11)
- [ ] 9. Add `Modules.Identity/Models/DeviceRegistration`: the read-only device row for the listing screen (SEC-06; seat enforcement is server-side, LIC-08)
- [ ] 10. Add `Modules.Identity/Models/SignedInStaff`: what a successful sign-in yields for the session projection — no token, no refresh material (DT-12, SEC-07)
