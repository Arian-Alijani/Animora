...
| 01 | Design System Foundation | in-progress | 3/37 | Items 1/3/4 done (packages pinned, project-map docs, Vazirmatn embedded); item 2 needs the user's answer on the dark palette before item 7 |
