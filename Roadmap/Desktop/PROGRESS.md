...
| 02 | Shell & Navigation | in-progress | 15/29 | Shell chrome, `Composition/AddDesktopApp()`, `Startup/StartupSequence` and the Reporting read seam + query handler in place; example screen's fake/VM/view and its registration (19-22) next |
