...
| 04 | Identity & Auth Screens | todo-ready | 0/41 | Step 0 generated `TODO.md`; the five decisions it encodes (rail-visible Stage A login, module-owned permission-claim catalog, split read/write seams, recorded field-format defaults, sign-in projected onto `ICurrentUserState` through a Mediator notification) are open to correction |
