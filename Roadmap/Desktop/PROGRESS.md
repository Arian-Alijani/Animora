...
| 02 | Shell & Navigation | todo-ready | 0/29 | Step 0 done; navigation/app-state abstractions go in `Desktop.UI`, implementations in `Desktop.App` (AT-09), example screen in `Modules.Reporting` |
